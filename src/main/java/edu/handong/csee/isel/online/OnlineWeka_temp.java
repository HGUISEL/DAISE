...
class Run{
	...
	public void setTP(String algorithm, int confusionMatrixValue) {
		OnlineWeka_temp.saveValue(this.TP, algorithm, confusionMatrixValue);
	}
	...
	public void setFN(String algorithm, int confusionMatrixValue) {
		OnlineWeka_temp.saveValue(this.FN, algorithm, confusionMatrixValue);
	}
	...
	public void setFP(String algorithm, int confusionMatrixValue) {
		OnlineWeka_temp.saveValue(this.FP, algorithm, confusionMatrixValue);
	}
	...
	public void setTN(String algorithm, int confusionMatrixValue) {
		OnlineWeka_temp.saveValue(this.TN, algorithm, confusionMatrixValue);
	}
	...
	public void setBuggy(String algorithm, int confusionMatrixValue) {
		OnlineWeka_temp.saveValue(this.buggy, algorithm, confusionMatrixValue);
	}
	...
	public void setClean(String algorithm, int confusionMatrixValue) {
		OnlineWeka_temp.saveValue(this.clean, algorithm, confusionMatrixValue);
	}
	...
	public void setTe_buggy(String algorithm, int confusionMatrixValue) {
		OnlineWeka_temp.saveValue(this.te_buggy, algorithm, confusionMatrixValue);
	}
	...
	public void setTe_clean(String algorithm, int confusionMatrixValue) {
		OnlineWeka_temp.saveValue(this.te_clean, algorithm, confusionMatrixValue);
	}
	...
	public void setClusters(String algorithm, int cluster) {
		OnlineWeka_temp.saveValue(this.clusters, algorithm, cluster);
	}
